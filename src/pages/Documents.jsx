...
import { supabase, checkSupabaseConnection, downloadFile } from '../lib/supabase';
...
function Documents() {
  ...
  const handleDownload = async (fileUrl, title) => {
    try {
      const { data, error } = await downloadFile('medical-documents', fileUrl);
      if (error) throw error;
